...
// TODO this is a hot method
	 ...
	 */
	private void generatePseudoLegalMoves(List<State> ouputMoves, int countOfPiecesTakingTurn,
		...
		for (int i = 0; i < countOfPiecesTakingTurn; i++) {
			...
			switch (piece) {
				...
				case WHITE_KING:
				case BLACK_KING:
					generatePseudoLegalKingMoves(currSquare, ouputMoves);
					break;
				default:
					assert false : "Thing on:" + squaresWithPiecesTakingTurn[i] + " is unknown piece: " + piece;
			}
	...
	private void generatePseudoLegalKingMoves(Square from, List<State> outputMoves) {
